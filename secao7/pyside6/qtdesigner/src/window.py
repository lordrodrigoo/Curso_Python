...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.labelName.setMouseTracking(False)
        ...
        self.pushSend = QPushButton(self.centralwidget)
        self.pushSend.setObjectName(u"pushSend")
        font3 = QFont()
        font3.setPointSize(31)
        self.pushSend.setFont(font3)

        self.gridLayout_2.addWidget(self.pushSend, 0, 2, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.labelResult.setText(QCoreApplication.translate("MainWindow", u"Mudando o texto", None))
        ...
        self.pushSend.setText(QCoreApplication.translate("MainWindow", u"enviar", None))
    # retranslateUi
